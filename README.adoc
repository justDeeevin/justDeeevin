...
I'm Devin. I'm a freshman at UMD who probably spends too much time writing code. Almost entirely self-taught, I've been programming for about 8 years.
...
image:https://trophy.ryglcloud.net/?username=justdeeevin&theme=darkhub&no-frame=true&column=6[My GitHub trophies, link=https://github.com/ryo-ma/github-profile-trophy]
...
- https://github.com/nix-community/stylix/blob/master/modules/ashell/hm.nix[Ashell stylix module]
- {by-name}/te/textlsp/package.nix[textlsp]
- {hm-modules}/programs/quickshell.nix[quickshell home-manager module]
- https://github.com/notashelf/nvf/blob/master/modules/plugins/assistant/supermaven-nvim.nix[Supermaven plugin in nvf]
- {by-name}/ug/ugdb/package.nix[ugdb]
====
